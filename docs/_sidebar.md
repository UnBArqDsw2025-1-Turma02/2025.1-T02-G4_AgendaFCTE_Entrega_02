...
- **Modelagem**
  - [2. Desenho de Software (Modelagem)](./Modelagem/2.Modelagem.md)
    ...
    - [2.5. Iniciativas Extras](./Modelagem/2.5.IniciativasExtras.md)
      ...
      - [2.5.2. Quadro de Conhecimentos](./Modelagem/quadroConhecimento.md)
      - [2.5.3. NFR Framework](./Modelagem/NFR.md)
      - [2.5.4. Especificações de Casos de Uso](./Modelagem/EspCasodeUso.md)
      - [2.5.5. Especificação Suplementar](./Modelagem/EspSuplementar.md)
      - [2.5.6. Heatmap](./Modelagem/heatmap.md)